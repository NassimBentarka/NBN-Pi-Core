...
You can use the [editor on GitHub](https://github.com/nassimosaz/NBN-Pi-Core/edit/main/docs/index.md) to maintain and preview the content for your website in Markdown files.
