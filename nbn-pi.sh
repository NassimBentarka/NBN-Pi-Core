...
ssh -t $pi_user@$1 "sudo ssh-keygen -t ed25519 -a 100"
echo -e "\033[33mRemotely copying the $pi_user@$1 SSH key to ${server_user//[[:blank:]]/}@${controller_ip//[[:blank:]]/}...\033[0m"
ssh -t $pi_user@$1 'SSH_OPTS="-F /dev/null" ServerUser="'$server_user'" && ControllerIP="'$controller_ip'" && sudo ssh-copy-id ${ServerUser//[[:blank:]]/}@${ControllerIP//[[:blank:]]/}'
